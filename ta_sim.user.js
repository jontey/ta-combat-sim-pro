...
(function () {
  var TASuite_mainFunction = function () {
	...
	updateStatsWindow : function() {
		...
		// BATTLE TIME
		this.setLabelColor(this.labels.time, this.totalSeconds / 120.0, -1); // max
																				// is
																				// 120s
	...
	setupBattleground : function(offense_units) {
		try {
			...
			if (((combatData.m_DefenderFaction === ClientLib.Base.EFactionType.FORFaction) || 
						(combatData.m_DefenderFaction === ClientLib.Base.EFactionType.NPCBase))
	...
	startSimulation : function() {
		try {
			...
			battleground.DHSWQJ.FCPPDZ((new $I.QUXOEF).LEUXCZ(this,this.onDamageDone)); 
			// m_Simulation became DHSWQJ, The add_DamageDone$0 has been renamed to FCPPDZ, System.EventHandler. renamed to $I.QUXOEF.LEUXCZ
