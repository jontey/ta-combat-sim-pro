      ...
      qx.Class.define("TASuite.main",
      {
        ...
        members :
        {
          ...
          initialize : function ()
          {
            ...
            this.CCTroopStrengthLabel = new qx.ui.basic.Label("100"),
            eHBox6.add(this.CCTroopStrengthLabel);
          ...
          getCityPreArmyUnits : function ()
          {
            ...
            for (var key in armyBar)
            {
              try
              {
                ...
                { // ClientLib.Data.CityPreArmyUnits renamed to $I.UIG  = $I.NSVPME *CHECKED*
                  units = armyBar[key];
                  break;
                }
              }
          ...
          onDamageDone : function (sender, e)
          {
            ...
            if (battleground.SAKGZR % 10 == 0)
            { // m_CurrentStep changed to SAKGZR
          ...
          calculateTroopStrengths : function (battleground)
          {
            ...
            for (var i in entities)
            {
              ...
              if (a_entity.XPEHRJ == 2)
              { // ??? has been renamed to XPEHRJ, Attacker is 2
                // This is one of the good guys
                end_hp += current_hp;
                total_hp += max_hp;
                switch (a_entity.TRKXAB)
                { // movement type has been renamed to TRKXAB
            ...
            this.lastInfantryRepairTime = crd.ConvertRepairCost(r_types.RepairChargeInf, repair_times[ClientLib.Data.EUnitGroup.Infantry], (1 - (i_end_hp + totalInfantryHealth - i_total_hp) / (totalInfantryHealth ? totalInfantryHealth : 1)));
            this.lastAircraftRepairTime = crd.ConvertRepairCost(r_types.RepairChargeAir, repair_times[ClientLib.Data.EUnitGroup.Aircraft], (1 - (a_end_hp + totalAirHealth - a_total_hp) / (totalAirHealth ? totalAirHealth : 1)));
            this.lastVehicleRepairTime = crd.ConvertRepairCost(r_types.RepairChargeVeh, repair_times[ClientLib.Data.EUnitGroup.Vehicle], (1 - (v_end_hp + totalVehicleHealth - v_total_hp) / (totalVehicleHealth ? totalVehicleHealth : 1)));
          ...
          updateStatsWindow : function ()
          {
            ...
            if (this.isPlayerCity)
              this.updateLabel100(this.CCTroopStrengthLabel, this.lastCCPercentage, -1);
            else
            {
