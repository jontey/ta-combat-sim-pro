        ...
        qx.Class.define("TASuite.main", {
          ...
          members: {
            ...
            onDamageDone: function (sender, e) {
              battleground = sender.GETXBE.i[0].o; // DamageDone was renamed to AQL
              // For the sake of performance, only run this every 10th step
              if (battleground.LTUPDH % 10 == 0) { // m_CurrentStep changed to BZF
            ...
            calculateTroopStrengths: function (battleground) {
              ...
              var repair_times = own_city.get_CityUnitsData().NBLSAX.d; // m_FullRawRepairTimeForUnitGroupTypes renamed to ZHG
              var r_types = ClientLib.Base.EResourceType;
              
              var entities = battleground.RMCABE.d; // m_Entities has been renamed to OAG
              
              for (var i in entities) {
                var entity = entities[i];
                var i_entity = entity.HLUBJW; // get_Entity$0() has been removed. Propery is $I.TQL - UBK
                var a_entity = entity.CMCLEW; // get_Entity$0() has been removed. Propery is $I.TQL - UBK
                var current_hp = i_entity.XKHWEF; // m_iHitpointsCurrent has been renamed to HUL
                var max_hp = i_entity.WCJQEN; // m_iHitpoints has been renamed to GUL
                if (a_entity.PSVMGQ == 2) { // m_eAlignment has been renamed to SIJ, Attacker is 2
                  // This is one of the good guys
                  end_hp += current_hp;
                  total_hp += max_hp;
                  switch (a_entity.UXBOFH) { // XIJ is the movement type
                  ...
                  switch (a_entity.UXBOFH) {
                    case ClientLib.Base.EUnitMovementType.Structure:
                      ...
                      if (i_entity.UYECHX >= 200 && i_entity.UYECHX <= 205) {
                        ...
                        switch (i_entity.UYECHX) { // m_MDCTypeId has been renamed to VTL
              ...
              crd.ConvertRepairCost = crd.RNUKEW;// ConvertRepairCost has been renamed to XWI
            ...
            setupBattleground: function () {
              try {
                ...
                combatData.TTAUEY = 1; // Version
                
                var unitData = own_city.get_CityUnitsData().HHYWQM().l;
                ...
                unitData = current_city.get_CityUnitsData().OCYIKN.l;
                data = new Array();
                ...
                combatData.MBBLBJ = data; // Defenders
                ...
                combatData.IPFXEV = data; // Terrain

                unitData = current_city.get_CityBuildingsData().ZATNVD.l;
                data = new Array();
                for (i = 0; i < unitData.length; i++) {
                  info = new Object();
                  info.h = unitData[i].get_Health();
                ...
                combatData.OQAQXC = data; // Buildings

                combatData.FOTQBA = null; // Support Structures
                combatData.DJWUYH = 8696244; // Start Step - this is just a random number
                ...
                combatData.RJXSNR = null; // Debug

                var battleground = ClientLib.Vis.VisMain.GetInstance().get_Battleground();
                battleground.Reset();
                battleground.QYEDFT = combatData;
                battleground.InitBattle();
                battleground.PRTRPU(combatData);
                battleground.StartBattle();
                if (battleground.MUVOAS < 0x1d4c0) {
                  //battleground.MUVOAS += 0xbb8;
                }
            ...
            startSimulation: function () {
              try {
                ...
                battleground.HXGRQD.GUADUH((new $I.WMJHOK).GEDTYY(this, this.onDamageDone)); // m_Simulation became MAG, The add_DamageDone$0 has been renamed to TOL, System.EventHandler.$ctor was renamed to $I.QQL.HGL
